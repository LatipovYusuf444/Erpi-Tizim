...
const FAKE_DATA: Row[] = [
  {
    ...
    item_price: 2000000,
    nds_percent: 45,
    price_with_nds: 2450000,
    total_price: 2080000,
  },
  {
    id: 202,
    client_name: "Farruh",
    product_title: "Plastik stakan",
    created_at: "2025-12-09T15:30:00Z",
    item_quantity: 41,
    item_price: 20580,
    nds_percent: 5,
    price_with_nds: 852000,
    total_price: 252000,
  },
  {
    id: 203,
    client_name: "Komil",
    product_title: "Plastik quti",
    created_at: "2025-10-24T11:00:00Z",
    item_quantity: 12,
    item_price: 418100,
    nds_percent: 7,
    price_with_nds: 415100,
    total_price: 938100,
  },
];
      ...
      <section className="bg-[#EBF0FA] border border-[#334F9D] rounded-3xl shadow-sm px-6 max-w-[1402px] my-8">
        <div className="flex items-center justify-between mb-4 mt-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => navigate("/moliya/kassa-jadvali-form")}
              type="button"
        ...
        {/*  error не показываем, потому что подставляем FAKE_DATA */}
