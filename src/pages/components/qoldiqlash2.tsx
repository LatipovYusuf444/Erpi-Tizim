        ...
        <div className="mt-14 grid grid-cols-12 gap-10">
          ...
          <div className="col-span-12 lg:col-span-5 space-y-7">
            <Field label="Ta’minotchi nomi">
              <input className="inp" placeholder="Firma / ism" />
            </Field>
            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              <Field label="Hujjat №">
                <input className="inp" defaultValue="778899" />
              </Field>
            </div>
          ...
          <div className="col-span-12 lg:col-span-7 space-y-7">
            <div className="grid grid-cols-2 gap-8">
              ...
              <Field label="Miqdori">
                <input className="inp" placeholder="Masalan: 20" />
              </Field>
            </div>
                ...
                {items.map((it, i) => (
                  <div key={i} className="grid grid-cols-12 gap-3">
                    ...
                    <button
                      type="button"
                      onClick={() => removeRow(i)}
                      className="col-span-1 h-13 rounded-xl border border-rose-200 bg-rose-50 text-rose-700 font-bold"
                    >
                      ×
                    </button>
                  </div>
            ...
            <Field label="Eslatma">
              <textarea className="inp min-h-42.5 resize-none" placeholder="Fikringiz..." />
            </Field>
          </div>
        </div>
      </div>
