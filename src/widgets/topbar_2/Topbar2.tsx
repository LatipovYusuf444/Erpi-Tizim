  ...
  return (
    <div className="px-8">
      ...
      {!hasActiveTab && (
        ...
        <div className="w-350.5 h-193.5 v bg-[#EBF0FA] border border-[#6049E3] rounded-2xl mt-7.25 ">

        <div className="w-[1402px] h-[775px] bg-[#EBF0FA] border border-[#334F9D] rounded-2xl mt-[29px] ">
